export const routeCategories = [
  ...
  },
  {
    ...
    icon: '🔗',
    items: [
      { name: '链动小铺 1', desc: '买 ChatGPT / Claude 订阅，比官方便宜', url: 'https://pay.ldxp.cn/shop/JL7007', tags: ['AI', '订阅'], addedAt: '2026-08-02', icon: '/assets/routes/链动小铺.png' },
      { name: '链动小铺 2', desc: '买 ChatGPT / Claude 订阅，比官方便宜', url: 'https://pay.ldxp.cn/shop/T37M9N2N/', tags: ['AI', '订阅'], addedAt: '2026-07-15', icon: '/assets/routes/链动小铺.png' },
