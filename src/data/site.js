export const routeCategories = [
  ...
  },
  {
    ...
    icon: '🤖',
    items: [
      { name: 'Claude', desc: 'Anthropic 的 AI 助手', url: 'https://claude.ai', tags: ['AI', '效率'], addedAt: '2026-07-25' },
      { name: 'ChatGPT', desc: 'OpenAI 的对话式 AI', url: 'https://chat.openai.com', tags: ['AI', '效率'], addedAt: '2026-07-25' },
      { name: '豆包', desc: '字节的 AI 助手', url: 'https://www.doubao.com', tags: ['AI', '效率'], addedAt: '2026-07-26' },
      { name: 'Gemini', desc: 'Google 的 AI 助手', url: 'https://gemini.google.com', tags: ['AI', '效率'], addedAt: '2026-07-26' },
    ]
  },
  {
    id: 'links',
    ...
    items: [
      ...
      { name: '鲜枣课堂', desc: '大量优质领域科普 PPT，可直接在线浏览', url: 'http://www.xzclass.com/?page_id=1', tags: ['学习', '科普'], addedAt: '2026-07-18' },
      { name: 'JavaGuide', desc: 'GitHub 156K+ Star 的 Java 面试与后端知识体系', url: 'https://javaguide.cn/', tags: ['学习', '开发'], addedAt: '2026-07-18' },
    ]
  },
  {
    id: 'campus',
    ...
    items: [
      ...
      { name: '西电信息网络技术中心', desc: '西电信息网络技术中心官网,网络问题可在该网站查找', url: 'https://xxzx.xidian.edu.cn/', tags: ['校园', '网络'], addedAt: '2026-07-30' },
    ]
  },
  {
    id: 'entertainment',
    ...
    icon: '🎮',
    items: [
      { name: 'Bilibili', desc: 'B 站 - 国内最大的弹幕视频网站', url: 'https://www.bilibili.com/', tags: ['视频', '娱乐'], addedAt: '2026-07-30' },
    ]
  },
  {
    id: 'local',
